...
- Layer toggles:
	...
	- Planets
	- Milky Way band
	- Satellites (from Celestrak visual satellites TLE)
	- Aircraft (from ADS-B via proxy)
	- Stellar temperature coloring
- Magnitude slider to filter visible stars by brightness
- Hover tooltips for stars, planets, satellites, and aircraft (mag, RA/Dec, alt/az, etc.)
